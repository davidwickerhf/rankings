...
- nodes_{article}.csv: Nodes that cite the article
- edges_{article}.csv: Edges between nodes that cite the article
"""
...
def main():
    ...
    for article in unique_articles:
        ...
        if len(article_nodes) >= args.min_cases:
            ...
            # Save filtered data
            article_nodes.to_csv(os.path.join(article_dir, 'nodes.csv'), index=False)
            article_edges.to_csv(os.path.join(article_dir, 'edges.csv'), index=False)
